...
public class MainPageObject {
  ...
  public String waitForElementAndGetAttribute(By by, String attribute, String error_meesage, long timeoutInSeconds){
    WebElement element = waitForElementPresent(by, error_meesage, timeoutInSeconds);
